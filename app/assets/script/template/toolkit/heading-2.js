(function() {var Handlebars = require("handlebars");if (typeof Handlebars.templates === 'undefined') {Handlebars.templates = {};}Handlebars.templates['toolkit/heading-2'] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<"
    ...
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.tag : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
    + ">\n";
},"useData":true});Handlebars.registerPartial('toolkit/heading-2', Handlebars.templates['toolkit/heading-2']);module.exports = Handlebars.templates['toolkit/heading-2'];})();